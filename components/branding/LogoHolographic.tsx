...
export function LogoHolographic() {
  return (
    <div class="relative w-80 h-80 mx-auto perspective-1000">
      <div
        class="w-full h-full"
        style="transform-style: preserve-3d; animation: hologram-rotate 20s linear infinite;"
      >
        <div
          class="absolute inset-0 border-2 border-primary/60 rounded-full"
          style="animation: pulse-ring 3s ease-in-out infinite"
        >
        </div>
        <div
          class="absolute inset-[12.5%] border-2 border-secondary/60 rounded-full"
          style="animation: pulse-ring 3s ease-in-out infinite 0.5s"
        >
        </div>
        <div
          class="absolute inset-[25%] border-2 border-accent/60 rounded-full"
