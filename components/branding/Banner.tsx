...
export function Banner({
  ...
  const banners = {
    gradient: (
      <div class="relative rounded-2xl overflow-hidden" style={{ background: 'linear-gradient(135deg, #8B5CF6 0%, #06B6D4 50%, #EC4899 100%)' }}>
        ...
        <div class="relative z-10 p-16 text-center">
          <div
            ...
            style={{ fontSize: '64px', letterSpacing: '4px', textTransform: 'lowercase', color: '#050508' }}
          >
            {title}
          </div>
          <div class="font-body text-body-lg" style={{ color: '#050508', opacity: 0.9 }}>
            {slogan}
          </div>
          {children}
        </div>
    ...
    dark: (
      <div class="relative rounded-2xl overflow-hidden border-2 border-primary/30" style={{ background: '#0F172A' }}>
        <div
        ...
        <div class="relative z-10 p-16 text-center">
          <div
            ...
            style={{ fontSize: '64px', letterSpacing: '4px', textTransform: 'lowercase' }}
          >
            {title}
          </div>
    ...
    "sound-wave": (
      <div class="relative rounded-2xl overflow-hidden border-2 border-primary/20" style={{ background: 'linear-gradient(180deg, #0F172A 0%, #1E1B4B 100%)' }}>
        <div class="relative z-10 p-16 text-center">
          {/* Sound Wave Visual */}
          ...
          <div
            ...
            style={{ fontSize: '56px', letterSpacing: '4px', textTransform: 'lowercase' }}
          >
            {title}
          </div>
    ...
    "radar-circle": (
      <div class="relative rounded-2xl overflow-hidden border-2 border-primary/20 p-10 text-center" style={{ background: '#0F172A' }}>
        {/* Radar Circle Visual */}
        <div class="relative w-50 h-50 mx-auto mb-6">
          ...
          <div
            ...
            style={{ width: '65%', height: '65%', transform: 'translate(-50%, -50%)' }}
          />
          <div
        ...
        <div
          class="font-heading font-black gradient-text"
          style={{ fontSize: '48px', letterSpacing: '4px', textTransform: 'lowercase' }}
        >
          {title}
        </div>
        <div class="text-foreground-muted text-body-lg mt-2">
